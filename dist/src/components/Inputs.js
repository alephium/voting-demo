...
export var Input = function (_a) {
    ...
    return (_jsx(StyledInputDiv, { children: _jsx(StyledInput, { id: id, placeholder: placeholder, value: value, type: type ? type : 'text', onChange: function (e) { return onChange(e); } }) }));
};
