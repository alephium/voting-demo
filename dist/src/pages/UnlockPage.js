...
var Page = function (_a) {
    ...
    return (_jsx(Modal, __assign({ isOpen: isModalOpen, shouldCloseOnEsc: true, shouldCloseOnOverlayClick: true, onRequestClose: noop, ariaHideApp: false }, { children: _jsxs(Container, { children: [_jsx(Header, { children: "This dApp requires an action" }), state == 'network select' && (_jsx(_Fragment, { children: _jsx(MultiList, { children: _jsx(MultiItem, __assign({ onClick: function () { return onUnlock(); } }, { children: "Connect wallet" })) }) })), state == 'pairing' && (_jsxs(_Fragment, { children: [_jsx(QRCodeSVG, { value: uri || '', size: 256, includeMargin: true }), _jsx(Input, { value: uri, readOnly: true })] }))] }) })));
};
