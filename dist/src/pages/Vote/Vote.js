...
var Vote = function () {
    ...
    var _b = useState(undefined), isClosed = _b[0], setIsClosed = _b[1];
    var _c = useState(undefined), contractRef = _c[0], setContractRef = _c[1];
    ...
    var load = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!context.apiClient) return [3 /*break*/, 2];
                    context.editCache({ currentContractId: contractTxId });
                    return [4 /*yield*/, context.apiClient.getContractRef(contractTxId)];
                case 1:
                    contractRef_1 = _a.sent();
                    if (contractRef_1) {
                        setContractRef(contractRef_1);
                        context.apiClient.getContractState(contractTxId).then(function (state) {
                            var encodedTitle = state.fields[0].value;
                            setTitle(hexStringToStr(encodedTitle));
                            var isClosed = state.fields[3].value;
