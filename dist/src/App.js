...
var App = function () {
    ...
    return (_jsx(GlobalContext.Provider, __assign({ value: {
            ...
            editCache: editCache,
            accounts: accounts
        } }, { children: _jsxs("div", __assign({ style: { display: 'flex', flexDirection: 'column', alignItems: 'center' } }, { children: [_jsxs("div", __assign({ style: { position: 'fixed', left: '1rem', top: '1rem' } }, { children: [_jsx(Logo, { src: logo }, void 0), networkType !== undefined && _jsx(NetworkBadge, { networkType: networkType }, void 0)] }), void 0), _jsxs(ContentContainer, { children: [_jsx(NavBarContainer, { children: _jsxs(NavBar, { children: [_jsx(NavBarItem, __assign({ exact: true, to: "/", activeStyle: stylePressedIn }, { children: "Create" }), void 0), _jsx(NavBarItem, __assign({ to: "/administrate", activeStyle: stylePressedIn }, { children: "Administrate" }), void 0), _jsx(NavBarItem, __assign({ to: "/vote", activeStyle: stylePressedIn }, { children: "Vote" }), void 0), _jsx(RedButton, __assign({ onClick: onDisconnect }, { children: "\u23FB" }), void 0)] }, void 0) }, void 0), _jsx(Address, { children: accounts[0] ? accounts[0].address : 'Unknown address' }, void 0), _jsxs(Switch, { children: [_jsx(Route, __assign({ exact: true, path: "/" }, { children: _jsx(Create, {}, void 0) }), void 0), _jsx(Route, __assign({ exact: true, path: "/vote/:txId" }, { children: _jsx(Vote, {}, void 0) }), void 0), _jsx(Route, __assign({ path: "/vote" }, { children: _jsx(Vote, {}, void 0) }), void 0), _jsx(Route, __assign({ exact: true, path: "/administrate/:txId" }, { children: _jsx(Administrate, {}, void 0) }), void 0), _jsx(Route, __assign({ path: "/administrate" }, { children: _jsx(Administrate, {}, void 0) }), void 0)] }, void 0), _jsx(UnlockPage, { isModalOpen: isUnlockOpen, onUnlock: handleUnlockWallet, uri: uri }, void 0)] }, void 0)] }), void 0) }), void 0));
};
/* Styles */
